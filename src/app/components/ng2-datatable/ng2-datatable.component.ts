...
import { Data } from '../pagetitle/data';
...
export class Ng2DatatableComponent implements OnInit {
  ...
  public columns:Array<any> = [
    ...
    {title: 'Name', name: 'name', className: ['office-header', 'text-success']},
    {title: 'Email', name: 'email', sort: '', },
    {title: 'Address', className: 'text-warning', name: 'address'},
  ...
  public constructor(private _fetchDataService: FetchDataService) {
